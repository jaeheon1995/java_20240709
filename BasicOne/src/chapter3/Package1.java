...
public static void main(String[] args) {
	...
	//자주 사용되는 기능
	//parse 메서드 : 문자열을 특정 타입으로 변환하려고 할 때 
	int number = Integer.parseInt("11234545");
	//toString 메서드 : 특정한 타입의 값을 문자열로 변환하려고 할 때
